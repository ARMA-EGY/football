...
;(function($){
	...
	var $chart_doughnut_soccer5 = $('#chart-doughnut-soccer-5');
	...
	var Core = {
		...
		ChartJs: function() {
			...
			if ( $chart_doughnut_soccer5.exists() ) {
				...
				var ctxdoughnut_soccer_5 = $chart_doughnut_soccer5;
				var gamesHistorySoccer5 = new Chart(ctxdoughnut_soccer_5, dataSoccer4);

				document.getElementById('chartDoughnutLegendSoccer5').innerHTML = gamesHistorySoccer5.generateLegend();
			}
